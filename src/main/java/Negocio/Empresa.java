...
public class Empresa {
    ...
    if (cliente == null) return "El documento ya está registrado con otro nombre";

    // --- Calcular valor con descuentos ---
    double valorPagar = calcularValorTiquete(s.getTarifa(), idaYVuelta, cliente);

    // Registrar la compra DESPUÉS de calcular el valor
    // (el descuento aplica a partir del tiquete 8, no del 7)
